...
const serviceContent =[
    ...
    {
        name: '9051 S Desert Palm Broken Arrow, OK 74012',
        routerPath: '#'
    },
          ...
          <div className="container">
            <div className="row gx-4 gx-xxl-5 mb-10">
              ...
              >
                <div className="footer__widget mb-40 px-xxl-5">
                  ...
                  <p className="fs-17 mb-0 pb-20">
                    To get our latest news, updates and special offers.
                  </p>
                  {/* SubscribeFormOne */}
                  <SubscribeFormOne />
                  {/* SubscribeFormOne */}
              ...
              >
                <div className="footer__widget mb-40">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6474.435154122167!2d-95.85535654476044!3d36.044268240464035!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x87b68c2fed492f2d%3A0x76ad4234284d9bf1!2sS%20Desert%20Palm%20Ave%2C%20Broken%20Arrow%2C%20OK%2074012!5e0!3m2!1sen!2sus!4v1748653657218!5m2!1sen!2sus"/>
                </div>
              </div>
            </div>
          </div>
